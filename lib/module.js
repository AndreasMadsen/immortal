...
(function () {
  ...
  exports.start = function (file /*, [options], callback*/) {
    ...
    // option: monitor
    if (typeof options.monitor !== 'string' && options.monitor !== null) {
      callback(new TypeError('options.monitor must be a string or null')); return;
    }
    // option: monitor
    ...
    function execFile() {
      ...
      if (options.strategy === 'development') {
        ...
        child = core.spawnPump(options, true);
